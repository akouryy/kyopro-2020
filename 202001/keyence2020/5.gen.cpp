...
using VI=vec<int>;using WI=vvec<int>;using VB=vec<bool>;using HPIII=map<pair<int, int>, int>;using VPII=vec<pair<int, int>>;
#line 1 "alias.hpp"//5b
...
/* </foxy.memo-area> */
  ...
  {if(debug)cerr<<'#'<<__LINE__ ln<<"  black: "<<(black)ln<<"  costs: "<<(costs)ln;}
